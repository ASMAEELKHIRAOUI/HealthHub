...
<div class="modal fade" id="productModal">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{route('product.store')}}" method="POST" id="add-form" enctype="multipart/form-data" data-parsley-validate>
                @csrf
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name="SaveProduct" class="color text-light border-white p-2 rounded w-25" id="save-btn">Save</button>
                </div>
            </form>
        </div>
    </div>
